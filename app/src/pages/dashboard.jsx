...
export const Dashboard = () => {
  ...
  // Static Data
  const {initialized,initUser, transactionPending,user} = useBlog();
  //  {
  //   name: "Sujal",
  ...
  return (
    <div className="dashboard bg-black overflow-auto h-screen">
      <header className="fixed z-10 w-full h-14  shadow-md">
        <div className="flex justify-between items-center h-full container">
          <h2 className="text-2xl font-bold">
            <div className="bg-clip-text bg-gradient-to-br from-indigo-300 colorpink text-green-400"
            >
              Nature SOLmate
            </div>
          </h2>
          {connected ? (
            <div className="flex items-center">
              ...
              {initialized ? (
                ...
                <Button
                  className="ml-3 mr-2 bg-green-400"
                  onClick={() => {
                    setShowModal(true)
                  }}
                >
          ...
          <div className="row">
            ...
            <article className="best-post">
              ...
              <div className="best-post-content">
                {/* <
                 */}
                <div className="best-post-content-title font-bold text-6xl">
                  Welcome to <span className="text-green-400">Nature SOLmate</span> 
                </div>
                <div className="best-post-content-sub text-green-300">
...
// "address": "8GeCgbNu9zdiXxVDCRwhAfN98awNUWRsA6pAuBjavxC4"
